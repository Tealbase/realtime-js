...
export default class RealtimeClient {
   ...
   * @param options.workerUrl The URL of the worker script. Defaults to https://realtime.tealbase.com/worker.js that includes a heartbeat event call to keep the connection alive.
   */
